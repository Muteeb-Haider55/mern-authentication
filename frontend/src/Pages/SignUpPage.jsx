...
const SignUpPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-wid-md w-2/6 bg-gray-800 bg-opacity-50 backdrop-filter
    ...
    >
      <div className="p-8">
        ...
        <form onSubmit={handleSignUp}>
          ...
          <motion.button
            className="mt-5 w-full py-3 bg-gradient-to-r from-green-500 to-emerald-600
      ...
      <div className="px-8 py-4 bg-gray-900 opacity-50 flex justify-center rounded-b-xl">
